          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              {[home.philosophy.stat1, home.philosophy.stat2, home.philosophy.stat3].map((stat) => (
                <div
                  key={stat.label}
                  className="flex items-center gap-6 p-6 rounded-xl border border-white/6 bg-white/[0.02]"
                >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {home.products.items.map((product, i) => (
              ...
              >
                <Link
                  href={product.href}
                  className="group block h-full rounded-2xl border border-white/6 bg-white/[0.02] p-8 md:p-10 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300"
                >
                  ...
                  <p className="text-lg font-light text-cream-200 mb-4">
                    {product.tagline}
                  </p>
